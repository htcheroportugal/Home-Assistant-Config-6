...
<p align="left">I have placed motion sensors in every room of my house as well as at the entrance to my property (facing the front door) and a few at the rear. I use external sensors are motion light sensors they turn on the front and rear lights upon motion detect. The interior ones in the playroom, laundry and bathrooms are also used to turn lights on and off with motion as I found my family just leave these lights on all day. I also use them for unauthorized motion detection once the alarm has been set to trigger TTS to warm intruder that alarm has been triggered and to get the f*** out as police have been notified, as well as set in motion the alarm sequence. I hope to start to also utilize these in conjuntion with other methods to introduce room detection/presence.</p>
