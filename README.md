...
<p align="left">I was excited to get this fan as it was to go into the playroom for the kids the room has no windows or is quiet closed off so airflow isn't the best. When it arrived I went to intergrate it with HA to realise that it is one of the few Xioami devices that didn't have auto discovery or a custom compnent for it. I reached out to the community and our very own @syssi had a component for me to do testing with in the matter of hours. We are actually only about 50% through this as it is waiting for me to finish testing the remainder of its functions and it will be added in future release. [Mi Smart Pedestal Fan](https://community.home-assistant.io/t/mi-smart-pedestal-fan/49998/52)</p>
